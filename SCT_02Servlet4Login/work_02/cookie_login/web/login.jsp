...
<form action="/loginServlet" method="post" onsubmit="return loginTest()">
    账户：<input type="text" id="account" name="account" placeholder="请输入您的账户" onblur="accountTest()">
    <br>
    密码：<input type="password" id="password" name="password" placeholder="请输入您的密码" onblur="passwordTest()">
    <br>
